...
export default function Products() {
  ...
  // Get token from localStorage (you'll need to save this during login)
                ...
                <tr key={p._id}>
                  {editingId === p._id ? (
                    <>
                      ...
                      <td><input type="text" name="barcode" value={editedData.barcode} onChange={handleEditChange} /></td>
                      <td><input type="number" name="quantity" value={editedData.quantity} onChange={handleEditChange} min="0" /></td>
                      <td><input type="number" step="0.01" name="price" value={editedData.price} onChange={handleEditChange} min="0" /></td>
                      <td className="actions">
                        <button className="icon-btn" onClick={() => handleSaveClick(p._id)} disabled={loading}>
                          <FaCheck />
                        </button>
                        <button className="icon-btn red" onClick={handleCancelClick} disabled={loading}>
                          <FaTimes />
                        </button>
                      </td>
                    </>
                    ...
                    <>
                      ...
                      <td className="actions">
                        <button className="icon-btn" onClick={() => handleEditClick(p)} disabled={loading}>
                          <FaEdit />
                        </button>
                        <button className="icon-btn red" onClick={() => handleDeleteProduct(p._id)} disabled={loading}>
                          <FaTrash />
                        </button>
                      </td>
                    </>
